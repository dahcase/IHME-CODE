...
********************************************************************************
local run 1 //1 denotes run the main script, 2 means run the gather


*Things that need to be set
local dalynatversion 54 //version of the dalynator
local vdversion 54_2 //`dalynatversion' //version of the venn diagram
local codeversion 1 //version of the code
local medversion 1 //version of the mediation
//////////Stage #:123456789
local instruction YYYYYYYYY //foreach stage, say whether you want to run this part (e.g. a y or n in the appropriate part)
...
local years all //contrain the years that the process runs.
